        ...
        <div className="flex flex-col sm:flex-row  justify-center items-center content-center fondo1  text-white w-full h-16 sm:h22 font-thin border-solid">
            <a 
              ...
              className="mx-11 transform hover:translate-y-1 transition-transform ease-in duration-200">
                <img className="fill-current ml-2 w-14 items-center " src={MinTic} alt="MinTic logo" /></a>
            <a href="https://github.com/PROYECTORIO" className="transform hover:translate-y-1 transition-transform ease-in duration-200 mx-11"><i className="fab fa-github w-6"></i>Proyecto Ciclo 4.</a>
